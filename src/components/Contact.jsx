...
const Contact = () => {
  return (
    <section className="min-h-screen w-full bg-[#09090b] px-4 sm:px-6 md:px-10 py-8 md:py-10 text-white scroll-mt-32">
      {/* Header Section */}
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={idx}
              className="bg-[#18181b] rounded-lg p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300 flex flex-col items-center space-y-4 border border-gray-700"
            >
              {/* Icon */}
